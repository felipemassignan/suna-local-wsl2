...
const DEFAULT_MODEL_ID = "local-mistral"; // Define default model ID
...
export const ChatInput = forwardRef<ChatInputHandles, ChatInputProps>(({
  ...
  const modelOptions = [
    { id: "local-mistral", label: "Local Mistral 7B" },
    { id: "local-mistral-thinking", label: "Local Mistral 7B (Thinking)" },
    { id: "sonnet-3.7", label: "Sonnet 3.7 (Cloud)" },
    { id: "gpt-4.1", label: "GPT-4.1 (Cloud)" }
  ];
